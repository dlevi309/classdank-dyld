    ...
    @autoreleasepool {
        ...
        if (isSharedCacheRecursive){
            ...
            if (fp==NULL){
                ...
                else if ([[NSFileManager defaultManager] fileExistsAtPath:@"/private/var/root/Gotcha/System/Library/Caches/com.apple.dyld/dyld_shared_cache_arm64e"]){
                    filename="/private/var/root/Gotcha/System/Library/Caches/com.apple.dyld/dyld_shared_cache_arm64e";
                }
